...
class PostController extends Controller {
  ...
  async getPostBySlug(req, res) {
    ...
    if (!post) throw createHttpError.NotFound("No post found with these details");
  ...
  async addNewPost(req, res) {
    ...
    if (!fileUploadPath || !filename)
      throw createHttpError.InternalServerError("Upload a post cover image");
    ...
    if (!post?._id) throw createHttpError.InternalServerError("Post was not created");
  ...
  async removePost(req, res) {
    ...
    if (!post._id) throw createHttpError.InternalServerError("Post was not deleted");
    return res.status(HttpStatus.OK).json({
      statusCode: HttpStatus.OK,
      data: {
  ...
  async findPostById(id) {
    ...
    if (!post) throw createHttpError.BadRequest("No post found with these details");
