...
function fileFilter(req, file, cb) {
  ...
  return cb(createError.BadRequest("The submitted file is not a valid image format"));
}
...
function videoFilter(req, file, cb) {
  ...
  return cb(createError.BadRequest("The submitted file is not a valid video format"));
}
...
function audioFilter(req, file, cb) {
  ...
  return cb(createError.BadRequest("The submitted file is not a valid voice format"));
}
